...
class CTrace : public CVMethod
{
public:
	void			TraceRay( const Ray_t &ray, unsigned int fMask, ITraceFilter *pTraceFilter, trace_t *pTrace );
	bool			IsVisible( CVector3& vStart, CVector3& vEnd, DWORD_PTR dwFlags, CBaseEntity* pEnt=NULL );
	ITraceFilter*	TraceFilterSkipTwoEntities( CBaseEntity* pEnt1, CBaseEntity* pEnt2 );
};
