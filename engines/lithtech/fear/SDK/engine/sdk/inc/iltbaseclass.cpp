...
uint32 ILTBaseClass::OnObjectCreated( const GenericPropList * pProps, float createType )
{ return EngineMessageFn(MID_OBJECTCREATED, (void*)pProps, createType); }
...
uint32 ILTBaseClass::OnLoadSFXMessage( ILTMessage_Read *pMsg, float fParam )
{ return EngineMessageFn( MID_LOADSPECIALEFFECTMESSAGE, pMsg, fParam ); }

uint32 ILTBaseClass::OnSaveSFXMessage( ILTMessage_Write *pMsg, float fParam )
{ return EngineMessageFn( MID_SAVESPECIALEFFECTMESSAGE, pMsg, fParam ); }
