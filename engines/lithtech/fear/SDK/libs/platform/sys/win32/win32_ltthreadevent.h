...
{
	LTASSERT(m_hEvent != INVALID_HANDLE_VALUE, "Attempt to SetEvent with invalid handle");
...
{
	LTASSERT(m_hEvent != INVALID_HANDLE_VALUE, "Attempt to ResetEvent with invalid handle");
...
{
	LTASSERT(m_hEvent != INVALID_HANDLE_VALUE, "Attempt to WaitForSingleObject with invalid handle");
