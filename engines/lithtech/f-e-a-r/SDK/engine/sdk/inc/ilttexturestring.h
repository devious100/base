...
//for the HDYNAMICTEXTURE definition
...
public:
	...
	CFontInfo(const char* pszTypeface, uint32 nHeight, uint32 nStyle = 0) :
		m_nHeight(nHeight),
		m_nStyle(nStyle)
	{
...
public:
	...
	virtual LTRESULT		GetTextureImage(HTEXTURESTRING hString, HDYNAMICTEXTURE& hTexture) = 0;
	...
	virtual LTRESULT		RenderSubString(HTEXTURESTRING hString,
											...
											const LTVector2& vGround		= LTVector2(1.0f, 0.0f),
											const LTVector2& vDown			= LTVector2(0.0f, 1.0f),
											const LTVector2& vStretch		= LTVector2(1.0f, 1.0f)) = 0;
