...
*/
	...
	// Don't send position information at all.
	NETFLAG_NOPOSCHANGES =		(1<<3),
	// Don't send rotation information at all.
	NETFLAG_NOROTCHANGES =		(1<<4),

	// used for monitoring if the object is in motion (engine internal)
	NETFLAG_INMOTION = (1 << 5),
};
...
spot so there is no \b LT_OUTOFMEMORY error.
*/
