...
void CL_Record_f (void)
{
	...
	FS_CreatePath (name);
	/*cls.demofile =*/ fopen_s(&cls.demofile, name, "wb"); // ***GREGS_VC9_PORT_MOD*** -- changed to safe version of fopen
	if (!cls.demofile)
	{
...
void Cmd_ForwardToServer (void)
{
	...
	if (Q_stricmp(cmd, "radar") == 0)
	{
		...
		Radar::Console::Display(cl_radarvisible, System::IntPtr::IntPtr(cl_hwnd)); // ***GREGS_VC9_PORT_MOD*** -- used IntPtr object to wrap native HWND type
		return;
	}
	#endif
...
void CL_Disconnect (void)
{
	...
	Netchan_Transmit ((netchan_t*)&cls.netchan, (int)strlen((const char*)final), final);
	Netchan_Transmit ((netchan_t*)&cls.netchan, (int)strlen((const char*)final), final);
	Netchan_Transmit ((netchan_t*)&cls.netchan, (int)strlen((const char*)final), final);
...
void CL_WriteConfiguration (void)
{
	...
	/*f =*/ fopen_s(&f, path, "w"); // ***GREGS_VC9_PORT_MOD*** -- changed to safe version of fopen
	if (!f)
	{
