...
// one update sometimes, so we always check all states and look for events
	...
	#if _MANAGED
		// pass event to the radar extension
		case WM_WINDOWPOSCHANGED:
			Radar::Console::WindowPosChanged(/*hWnd*/System::IntPtr(hWnd)); // ***GREGS_VC9_PORT_MOD*** -- converted hWnd to IntPtr type
			return DefWindowProc (hWnd, uMsg, wParam, lParam);
	#endif
...
qboolean VID_LoadRefresh( char *name )
{
	...
	if ( ( GetRefAPI = (GetRefAPI_t)(void*)GetProcAddress( reflib_library, "GetRefAPI" ) ) == 0 )
