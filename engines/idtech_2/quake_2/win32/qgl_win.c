...
qboolean QGL_Init( const char *dllname )
{
	...
	qglAccum                     = dllAccum = (void (__stdcall *)(GLenum,GLfloat))GPA( "glAccum" );
	qglAlphaFunc                 = dllAlphaFunc = (void (__stdcall *)(GLenum,GLclampf))GPA( "glAlphaFunc" );
	qglAreTexturesResident       = dllAreTexturesResident = (GLboolean (__stdcall *)(GLsizei,const GLuint *,GLboolean *))GPA( "glAreTexturesResident" );
	qglArrayElement              = dllArrayElement = (void (__stdcall *)(GLint))GPA( "glArrayElement" );
	qglBegin                     = dllBegin = (void (__stdcall *)(GLenum))GPA( "glBegin" );
	qglBindTexture               = dllBindTexture = (void (__stdcall *)(GLenum,GLuint))GPA( "glBindTexture" );
	qglBitmap                    = dllBitmap = (void (__stdcall *)(GLsizei,GLsizei,GLfloat,GLfloat,GLfloat,GLfloat,const GLubyte *))GPA( "glBitmap" );
	qglBlendFunc                 = dllBlendFunc = (void (__stdcall *)(GLenum,GLenum))GPA( "glBlendFunc" );
	qglCallList                  = dllCallList = (void (__stdcall *)(GLuint))GPA( "glCallList" );
	qglCallLists                 = dllCallLists = (void (__stdcall *)(GLsizei,GLenum,const GLvoid *))GPA( "glCallLists" );
	qglClear                     = dllClear = (void (__stdcall *)(GLbitfield))GPA( "glClear" );
	qglClearAccum                = dllClearAccum = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glClearAccum" );
	qglClearColor                = dllClearColor = (void (__stdcall *)(GLclampf,GLclampf,GLclampf,GLclampf))GPA( "glClearColor" );
	qglClearDepth                = dllClearDepth = (void (__stdcall *)(GLclampd))GPA( "glClearDepth" );
	qglClearIndex                = dllClearIndex = (void (__stdcall *)(GLfloat))GPA( "glClearIndex" );
	qglClearStencil              = dllClearStencil = (void (__stdcall *)(GLint))GPA( "glClearStencil" );
	qglClipPlane                 = dllClipPlane = (void (__stdcall *)(GLenum,const GLdouble *))GPA( "glClipPlane" );
	qglColor3b                   = dllColor3b = (void (__stdcall *)(GLbyte,GLbyte,GLbyte))GPA( "glColor3b" );
	qglColor3bv                  = dllColor3bv = (void (__stdcall *)(const GLbyte *))GPA( "glColor3bv" );
	qglColor3d                   = dllColor3d = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glColor3d" );
	qglColor3dv                  = dllColor3dv = (void (__stdcall *)(const GLdouble *))GPA( "glColor3dv" );
	qglColor3f                   = dllColor3f = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glColor3f" );
	qglColor3fv                  = dllColor3fv = (void (__stdcall *)(const GLfloat *))GPA( "glColor3fv" );
	qglColor3i                   = dllColor3i = (void (__stdcall *)(GLint,GLint,GLint))GPA( "glColor3i" );
	qglColor3iv                  = dllColor3iv = (void (__stdcall *)(const GLint *))GPA( "glColor3iv" );
	qglColor3s                   = dllColor3s = (void (__stdcall *)(GLshort,GLshort,GLshort))GPA( "glColor3s" );
	qglColor3sv                  = dllColor3sv = (void (__stdcall *)(const GLshort *))GPA( "glColor3sv" );
	qglColor3ub                  = dllColor3ub = (void (__stdcall *)(GLubyte,GLubyte,GLubyte))GPA( "glColor3ub" );
	qglColor3ubv                 = dllColor3ubv = (void (__stdcall *)(const GLubyte *))GPA( "glColor3ubv" );
	qglColor3ui                  = dllColor3ui = (void (__stdcall *)(GLuint,GLuint,GLuint))GPA( "glColor3ui" );
	qglColor3uiv                 = dllColor3uiv = (void (__stdcall *)(const GLuint *))GPA( "glColor3uiv" );
	qglColor3us                  = dllColor3us = (void (__stdcall *)(GLushort,GLushort,GLushort))GPA( "glColor3us" );
	qglColor3usv                 = dllColor3usv = (void (__stdcall *)(const GLushort *))GPA( "glColor3usv" );
	qglColor4b                   = dllColor4b = (void (__stdcall *)(GLbyte,GLbyte,GLbyte,GLbyte))GPA( "glColor4b" );
	qglColor4bv                  = dllColor4bv = (void (__stdcall *)(const GLbyte *))GPA( "glColor4bv" );
	qglColor4d                   = dllColor4d = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glColor4d" );
	qglColor4dv                  = dllColor4dv = (void (__stdcall *)(const GLdouble *))GPA( "glColor4dv" );
	qglColor4f                   = dllColor4f = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glColor4f" );
	qglColor4fv                  = dllColor4fv = (void (__stdcall *)(const GLfloat *))GPA( "glColor4fv" );
	qglColor4i                   = dllColor4i = (void (__stdcall *)(GLint,GLint,GLint,GLint))GPA( "glColor4i" );
	qglColor4iv                  = dllColor4iv = (void (__stdcall *)(const GLint *))GPA( "glColor4iv" );
	qglColor4s                   = dllColor4s = (void (__stdcall *)(GLshort,GLshort,GLshort,GLshort))GPA( "glColor4s" );
	qglColor4sv                  = dllColor4sv = (void (__stdcall *)(const GLshort *))GPA( "glColor4sv" );
	qglColor4ub                  = dllColor4ub = (void (__stdcall *)(GLubyte,GLubyte,GLubyte,GLubyte))GPA( "glColor4ub" );
	qglColor4ubv                 = dllColor4ubv = (void (__stdcall *)(const GLubyte *))GPA( "glColor4ubv" );
	qglColor4ui                  = dllColor4ui = (void (__stdcall *)(GLuint,GLuint,GLuint,GLuint))GPA( "glColor4ui" );
	qglColor4uiv                 = dllColor4uiv = (void (__stdcall *)(const GLuint *))GPA( "glColor4uiv" );
	qglColor4us                  = dllColor4us = (void (__stdcall *)(GLushort,GLushort,GLushort,GLushort))GPA( "glColor4us" );
	qglColor4usv                 = dllColor4usv = (void (__stdcall *)(const GLushort *))GPA( "glColor4usv" );
	qglColorMask                 = dllColorMask = (void (__stdcall *)(GLboolean,GLboolean,GLboolean,GLboolean))GPA( "glColorMask" );
	qglColorMaterial             = dllColorMaterial = (void (__stdcall *)(GLenum,GLenum))GPA( "glColorMaterial" );
	qglColorPointer              = dllColorPointer = (void (__stdcall *)(GLint,GLenum,GLsizei,const GLvoid *))GPA( "glColorPointer" );
	qglCopyPixels                = dllCopyPixels = (void (__stdcall *)(GLint,GLint,GLsizei,GLsizei,GLenum))GPA( "glCopyPixels" );
	qglCopyTexImage1D            = dllCopyTexImage1D = (void (__stdcall *)(GLenum,GLint,GLenum,GLint,GLint,GLsizei,GLint))GPA( "glCopyTexImage1D" );
	qglCopyTexImage2D            = dllCopyTexImage2D = (void (__stdcall *)(GLenum,GLint,GLenum,GLint,GLint,GLsizei,GLsizei,GLint))GPA( "glCopyTexImage2D" );
	qglCopyTexSubImage1D         = dllCopyTexSubImage1D = (void (__stdcall *)(GLenum,GLint,GLint,GLint,GLint,GLsizei))GPA( "glCopyTexSubImage1D" );
	qglCopyTexSubImage2D         = dllCopyTexSubImage2D = (void (__stdcall *)(GLenum,GLint,GLint,GLint,GLint,GLint,GLsizei,GLsizei))GPA( "glCopyTexSubImage2D" );
	qglCullFace                  = dllCullFace = (void (__stdcall *)(GLenum))GPA( "glCullFace" );
	qglDeleteLists               = dllDeleteLists = (void (__stdcall *)(GLuint,GLsizei))GPA( "glDeleteLists" );
	qglDeleteTextures            = dllDeleteTextures = (void (__stdcall *)(GLsizei,const GLuint *))GPA( "glDeleteTextures" );
	qglDepthFunc                 = dllDepthFunc = (void (__stdcall *)(GLenum))GPA( "glDepthFunc" );
	qglDepthMask                 = dllDepthMask = (void (__stdcall *)(GLboolean))GPA( "glDepthMask" );
	qglDepthRange                = dllDepthRange = (void (__stdcall *)(GLclampd,GLclampd))GPA( "glDepthRange" );
	qglDisable                   = dllDisable = (void (__stdcall *)(GLenum))GPA( "glDisable" );
	qglDisableClientState        = dllDisableClientState = (void (__stdcall *)(GLenum))GPA( "glDisableClientState" );
	qglDrawArrays                = dllDrawArrays = (void (__stdcall *)(GLenum,GLint,GLsizei))GPA( "glDrawArrays" );
	qglDrawBuffer                = dllDrawBuffer = (void (__stdcall *)(GLenum))GPA( "glDrawBuffer" );
	qglDrawElements              = dllDrawElements = (void (__stdcall *)(GLenum,GLsizei,GLenum,const GLvoid *))GPA( "glDrawElements" );
	qglDrawPixels                = dllDrawPixels = (void (__stdcall *)(GLsizei,GLsizei,GLenum,GLenum,const GLvoid *))GPA( "glDrawPixels" );
	qglEdgeFlag                  = dllEdgeFlag = (void (__stdcall *)(GLboolean))GPA( "glEdgeFlag" );
	qglEdgeFlagPointer           = dllEdgeFlagPointer = (void (__stdcall *)(GLsizei,const GLvoid *))GPA( "glEdgeFlagPointer" );
	qglEdgeFlagv                 = dllEdgeFlagv = (void (__stdcall *)(const GLboolean *))GPA( "glEdgeFlagv" );
	qglEnable                    = 	dllEnable                    = (void (__stdcall *)(GLenum))GPA( "glEnable" );
	qglEnableClientState         = 	dllEnableClientState         = (void (__stdcall *)(GLenum))GPA( "glEnableClientState" );
	qglEnd                       = 	dllEnd                       = (void (__stdcall *)(void))GPA( "glEnd" );
	qglEndList                   = 	dllEndList                   = (void (__stdcall *)(void))GPA( "glEndList" );
	qglEvalCoord1d				 = 	dllEvalCoord1d				 = (void (__stdcall *)(GLdouble))GPA( "glEvalCoord1d" );
	qglEvalCoord1dv              = 	dllEvalCoord1dv              = (void (__stdcall *)(const GLdouble *))GPA( "glEvalCoord1dv" );
	qglEvalCoord1f               = 	dllEvalCoord1f               = (void (__stdcall *)(GLfloat))GPA( "glEvalCoord1f" );
	qglEvalCoord1fv              = 	dllEvalCoord1fv              = (void (__stdcall *)(const GLfloat *))GPA( "glEvalCoord1fv" );
	qglEvalCoord2d               = 	dllEvalCoord2d               = (void (__stdcall *)(GLdouble,GLdouble))GPA( "glEvalCoord2d" );
	qglEvalCoord2dv              = 	dllEvalCoord2dv              = (void (__stdcall *)(const GLdouble *))GPA( "glEvalCoord2dv" );
	qglEvalCoord2f               = 	dllEvalCoord2f               = (void (__stdcall *)(GLfloat,GLfloat))GPA( "glEvalCoord2f" );
	qglEvalCoord2fv              = 	dllEvalCoord2fv              = (void (__stdcall *)(const GLfloat *))GPA( "glEvalCoord2fv" );
	qglEvalMesh1                 = 	dllEvalMesh1                 = (void (__stdcall *)(GLenum,GLint,GLint))GPA( "glEvalMesh1" );
	qglEvalMesh2                 = 	dllEvalMesh2                 = (void (__stdcall *)(GLenum,GLint,GLint,GLint,GLint))GPA( "glEvalMesh2" );
	qglEvalPoint1                = 	dllEvalPoint1                = (void (__stdcall *)(GLint))GPA( "glEvalPoint1" );
	qglEvalPoint2                = 	dllEvalPoint2                = (void (__stdcall *)(GLint,GLint))GPA( "glEvalPoint2" );
	qglFeedbackBuffer            = 	dllFeedbackBuffer            = (void (__stdcall *)(GLsizei,GLenum,GLfloat *))GPA( "glFeedbackBuffer" );
	qglFinish                    = 	dllFinish                    = (void (__stdcall *)(void))GPA( "glFinish" );
	qglFlush                     = 	dllFlush                     = (void (__stdcall *)(void))GPA( "glFlush" );
	qglFogf                      = 	dllFogf                      = (void (__stdcall *)(GLenum,GLfloat))GPA( "glFogf" );
	qglFogfv                     = 	dllFogfv                     = (void (__stdcall *)(GLenum,const GLfloat *))GPA( "glFogfv" );
	qglFogi                      = 	dllFogi                      = (void (__stdcall *)(GLenum,GLint))GPA( "glFogi" );
	qglFogiv                     = 	dllFogiv                     = (void (__stdcall *)(GLenum,const GLint *))GPA( "glFogiv" );
	qglFrontFace                 = 	dllFrontFace                 = (void (__stdcall *)(GLenum))GPA( "glFrontFace" );
	qglFrustum                   = 	dllFrustum                   = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glFrustum" );
	qglGenLists                  = 	dllGenLists                  = (GLuint (__stdcall *)(GLsizei))GPA( "glGenLists" );
	qglGenTextures               = 	dllGenTextures               = (void (__stdcall *)(GLsizei,GLuint *))GPA( "glGenTextures" );
	qglGetBooleanv               = 	dllGetBooleanv               = (void (__stdcall *)(GLenum,GLboolean *))GPA( "glGetBooleanv" );
	qglGetClipPlane              = 	dllGetClipPlane              = (void (__stdcall *)(GLenum,GLdouble *))GPA( "glGetClipPlane" );
	qglGetDoublev                = 	dllGetDoublev                = (void (__stdcall *)(GLenum,GLdouble *))GPA( "glGetDoublev" );
	qglGetError                  = 	dllGetError                  = (GLenum (__stdcall *)(void))GPA( "glGetError" );
	qglGetFloatv                 = 	dllGetFloatv                 = (void (__stdcall *)(GLenum,GLfloat *))GPA( "glGetFloatv" );
	qglGetIntegerv               = 	dllGetIntegerv               = (void (__stdcall *)(GLenum,GLint *))GPA( "glGetIntegerv" );
	qglGetLightfv                = 	dllGetLightfv                = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetLightfv" );
	qglGetLightiv                = 	dllGetLightiv                = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetLightiv" );
	qglGetMapdv                  = 	dllGetMapdv                  = (void (__stdcall *)(GLenum,GLenum,GLdouble *))GPA( "glGetMapdv" );
	qglGetMapfv                  = 	dllGetMapfv                  = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetMapfv" );
	qglGetMapiv                  = 	dllGetMapiv                  = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetMapiv" );
	qglGetMaterialfv             = 	dllGetMaterialfv             = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetMaterialfv" );
	qglGetMaterialiv             = 	dllGetMaterialiv             = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetMaterialiv" );
	qglGetPixelMapfv             = 	dllGetPixelMapfv             = (void (__stdcall *)(GLenum,GLfloat *))GPA( "glGetPixelMapfv" );
	qglGetPixelMapuiv            = 	dllGetPixelMapuiv            = (void (__stdcall *)(GLenum,GLuint *))GPA( "glGetPixelMapuiv" );
	qglGetPixelMapusv            = 	dllGetPixelMapusv            = (void (__stdcall *)(GLenum,GLushort *))GPA( "glGetPixelMapusv" );
	qglGetPointerv               = 	dllGetPointerv               = (void (__stdcall *)(GLenum,GLvoid ** ))GPA( "glGetPointerv" );
	qglGetPolygonStipple         = 	dllGetPolygonStipple         = (void (__stdcall *)(GLubyte *))GPA( "glGetPolygonStipple" );
	qglGetString                 = 	dllGetString                 = (const GLubyte *(__stdcall *)(GLenum))GPA( "glGetString" );
	qglGetTexEnvfv               = 	dllGetTexEnvfv               = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetTexEnvfv" );
	qglGetTexEnviv               = 	dllGetTexEnviv               = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetTexEnviv" );
	qglGetTexGendv               = 	dllGetTexGendv               = (void (__stdcall *)(GLenum,GLenum,GLdouble *))GPA( "glGetTexGendv" );
	qglGetTexGenfv               = 	dllGetTexGenfv               = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetTexGenfv" );
	qglGetTexGeniv               = 	dllGetTexGeniv               = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetTexGeniv" );
	qglGetTexImage               = 	dllGetTexImage               = (void (__stdcall *)(GLenum,GLint,GLenum,GLenum,GLvoid *))GPA( "glGetTexImage" );
	qglGetTexLevelParameterfv    = 	dllGetTexLevelParameterfv    = (void (__stdcall *)(GLenum,GLint,GLenum,GLfloat *))GPA( "glGetLevelParameterfv" );
	qglGetTexLevelParameteriv    = 	dllGetTexLevelParameteriv    = (void (__stdcall *)(GLenum,GLint,GLenum,GLint *))GPA( "glGetLevelParameteriv" );
	qglGetTexParameterfv         = 	dllGetTexParameterfv         = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetTexParameterfv" );
	qglGetTexParameteriv         = 	dllGetTexParameteriv         = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetTexParameteriv" );
	qglHint                      = 	dllHint                      = (void (__stdcall *)(GLenum,GLenum))GPA( "glHint" );
	qglIndexMask                 = 	dllIndexMask                 = (void (__stdcall *)(GLuint))GPA( "glIndexMask" );
	qglIndexPointer              = 	dllIndexPointer              = (void (__stdcall *)(GLenum,GLsizei,const GLvoid *))GPA( "glIndexPointer" );
	qglIndexd                    = 	dllIndexd                    = (void (__stdcall *)(GLdouble))GPA( "glIndexd" );
	qglIndexdv                   = 	dllIndexdv                   = (void (__stdcall *)(const GLdouble *))GPA( "glIndexdv" );
	qglIndexf                    = 	dllIndexf                    = (void (__stdcall *)(GLfloat))GPA( "glIndexf" );
